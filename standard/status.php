          ...
          <h3 class="font-mirt">หน้าเอกสารทั้งหมด</h3>
            ...
            <div class="tab-content font">
                <div id="home" class="container-fluid tab-pane active m-2">
                    <div align="right">
                <a href="?page=insert2" class="btn bt mg-t-bt b-add text-white mg-r" style="background:#4CAF50;"><h5>เพิ่มเอกสาร</h5></a>
</div>
                <hr>
                    <form method="post">
                                ...
                                <?php while ($data = sqlsrv_fetch_array($query, SQLSRV_FETCH_ASSOC)) : ?>
                                    <tr class="text-center">
                                        ...
                                        <?php if($data['id_statuss'] == 2 ) : ?>
                                            <td class="align-middle  text-white" style="background-color: #5F9EA0"><?= $data['name_status'] ?></td>
                                        <?php endif ; ?>
                                        <?php if($data['id_statuss'] == 3 ) : ?>
                                            <td class="align-middle bg-secondary text-white"><?= $data['name_status'] ?></td>
                                        <?php endif ; ?>
                                        <?php if($data['id_statuss'] == '' ) : ?>
                                            <td class="align-middle text-white" style="background-color : #FF7F50 ;"><?= $data['name_status'] ?></td>
                                        <?php endif ; ?>
                                        <td class="align-middle">
                                            <div class="mb-3">
                                                ...
                                                <a href="?page=detail&standard_idtb=<?= $data['standard_idtb'] ?>" class="btn btn-sm" style="background-color:#31f9cb;">ดูรายละเอียด</a>
